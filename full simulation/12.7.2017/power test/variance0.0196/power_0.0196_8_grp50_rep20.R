...
b.var <- c(0.0196) # The set of varaince of random covariates b as random slope
nRandCovariate <- 8
cores <- 2
r.sim <- b.var
...
fileName <- paste("power_", b.var, "_grp50-rep20-", nRandCovariate,".RData", sep = "") # Saving file's name
