...
b.var <- c(0.0004) # The set of varaince of random covariates b as random slope
nRandCovariate <- 2
cores <- 4
r.sim <- b.var
...
fileName <- paste("power_", b.var, "_grp200-rep50-", nRandCovariate,".RData", sep = "") # Saving file's name
