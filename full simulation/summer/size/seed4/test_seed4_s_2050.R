...
fileName <- paste("test_size_", smooth, "_",b.var,"_seed4_grp20-rep50.RData", sep = "") # Saving file's name
...
power2.sim[[loopIndex]] <- list(Power = Power2, realTau = c(r.sim,r.sim/2,r.sim/4), 
                                smooth = smooth, 
                                npc.sum = npc.sum, single_test_sec = single_testtime)
