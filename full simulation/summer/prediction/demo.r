...
b.var <- c(0.02) # The set of varaince of random covariates b as random slope
...
run_one_sample <- function(iter){
  ...
  mseNoRandom <- mean((Y - predict(NoRandomReml))^2) #6278.428  
  # npc
...
fileName <- paste("h_f_power_", smooth, "_",b.var,"_seed1_grp20-rep20.RData", sep = "") # Saving file's name
