...
RMSE_RandomReml <- calculateRMSE_i(fmridata$rating, predict(RandomReml)) #76.85496
RMSE_NoRandomReml <- calculateRMSE_i(fmridata$rating, predict(NoRandomReml)) #85.757

library(MuMIn)
r.squaredGLMM(RandomReml) #0.6430674
r.squaredGLMM(NoRandomReml) #0.5433735
