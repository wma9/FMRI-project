...
npc <- results$npc # voxel=19 then npc=8
...
mseNoRandom <- mean((fmridata$rating - predict(NoRandomReml))^2) #6463.045  
# npc=8
...
mseRandom <- mean((fmridata$rating - predict(RandomReml))^2) #5879.517 
...
msefullReml<- mean(residuals(fullReml)^2) #5833.417
...
mean((yhat_fullRemlBack-fmridata$rating)^2) #5833.417
...
plot(t, betai[,1], col=colors()[c(3)],type="l", ylim=c(min(betai)-5, max(betai)+1),
...
plot(t, beta2[,2],type="l", ylim=c(f_ymin,f_ymax),
     ...
     cex.lab = 0.8, cex.axis=0.8,cex.main=0.8, cex.sub=0.8,
     main="Suject 1 (ROI 19)", col="blue", lwd=2)
...
plot(t, beta2[,5],type="l", ylim=c(f_ymin,f_ymax),
     xaxt='n', ylab=expression(beta(t)+beta[i](t)), xlab="Time (Seconds)", lty=1, 
     cex.lab = 0.8, cex.axis=0.8,cex.main=0.8, cex.sub=0.8,
     main="Suject 4 (ROI 19)", col="blue", lwd=2)
...
plot(t, beta2[,10],type="l", ylim=c(f_ymin,f_ymax),
     xaxt='n', ylab=expression(beta(t)+beta[i](t)), xlab="Time (Seconds)", lty=1, 
     cex.lab = 0.8, cex.axis=0.8,cex.main=0.8, cex.sub=0.8,
     main="Suject 9 (ROI 19)", col="blue", lwd=2)
...
plot(t, beta2[,20],type="l", ylim=c(f_ymin,f_ymax),
     xaxt='n', ylab=expression(beta(t)+beta[i](t)), xlab="Time (Seconds)", lty=1, 
     cex.lab = 0.8, cex.axis=0.8,cex.main=0.8, cex.sub=0.8,
     main="Suject 19 (ROI 19)", col="blue", lwd=2)
