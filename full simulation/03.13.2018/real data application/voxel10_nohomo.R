...
RMSE_RandomReml <- calculateRMSE_i(fmridata$rating, predict(RandomReml)) #74.63737
RMSE_NoRandomReml <- calculateRMSE_i(fmridata$rating, predict(NoRandomReml)) #80.60125

library(MuMIn)
r.squaredGLMM(RandomReml) #0.65
r.squaredGLMM(NoRandomReml) #0.60
