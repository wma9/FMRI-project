...
b.var <- c(0.0729) # The set of varaince of random covariates b as random slope
...
fileName <- paste("h_f_power_", smooth, "_",b.var,"_grp20-rep50.RData", sep = "") # Saving file's name
